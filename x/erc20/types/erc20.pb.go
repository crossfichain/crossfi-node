...
// source: crossfi/erc20/v1/erc20.proto
...
func (Owner) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_1c4e87accdbc4277, []int{0}
}
...
type TokenPair struct {
	...
	ContractOwner Owner  `protobuf:"varint,4,opt,name=contract_owner,json=contractOwner,proto3,enum=crossfi.erc20.v1.Owner" json:"contract_owner,omitempty"`
	Erc20Cheque   string `protobuf:"bytes,5,opt,name=erc20_cheque,json=erc20Cheque,proto3" json:"erc20_cheque,omitempty"`
}
...
func (m *TokenPair) GetErc20Cheque() string {
	if m != nil {
		return m.Erc20Cheque
	}
	return ""
}
...
type RegisterCoinProposal struct {
	...
	EnableCheque bool             `protobuf:"varint,4,opt,name=enable_cheque,json=enableCheque,proto3" json:"enable_cheque,omitempty"`
}
...
func (*RegisterCoinProposal) Descriptor() ([]byte, []int) {
	return fileDescriptor_1c4e87accdbc4277, []int{1}
}
...
func (m *RegisterCoinProposal) GetEnableCheque() bool {
	if m != nil {
		return m.EnableCheque
	}
	return false
}
...
func (*RegisterERC20Proposal) Descriptor() ([]byte, []int) {
	return fileDescriptor_1c4e87accdbc4277, []int{2}
}
...
func (*ToggleTokenConversionProposal) Descriptor() ([]byte, []int) {
	return fileDescriptor_1c4e87accdbc4277, []int{3}
}
...
func (*ProposalMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_1c4e87accdbc4277, []int{4}
}
...
func init() {
	proto.RegisterEnum("crossfi.erc20.v1.Owner", Owner_name, Owner_value)
	proto.RegisterType((*TokenPair)(nil), "crossfi.erc20.v1.TokenPair")
	proto.RegisterType((*RegisterCoinProposal)(nil), "crossfi.erc20.v1.RegisterCoinProposal")
	proto.RegisterType((*RegisterERC20Proposal)(nil), "crossfi.erc20.v1.RegisterERC20Proposal")
	proto.RegisterType((*ToggleTokenConversionProposal)(nil), "crossfi.erc20.v1.ToggleTokenConversionProposal")
	proto.RegisterType((*ProposalMetadata)(nil), "crossfi.erc20.v1.ProposalMetadata")
}

func init() { proto.RegisterFile("crossfi/erc20/v1/erc20.proto", fileDescriptor_1c4e87accdbc4277) }

var fileDescriptor_1c4e87accdbc4277 = []byte{
	// 545 bytes of a gzipped FileDescriptorProto
	,
}
...
func (this *TokenPair) Equal(that interface{}) bool {
	...
	if this.Erc20Cheque != that1.Erc20Cheque {
		return false
	}
	return true
}
...
func (m *TokenPair) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.Erc20Cheque) > 0 {
		i -= len(m.Erc20Cheque)
		copy(dAtA[i:], m.Erc20Cheque)
		i = encodeVarintErc20(dAtA, i, uint64(len(m.Erc20Cheque)))
		i--
		dAtA[i] = 0x2a
	}
...
func (m *TokenPair) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Erc20Cheque", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Erc20Cheque = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func (m *RegisterCoinProposal) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field EnableCheque", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
