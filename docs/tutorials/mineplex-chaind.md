...
```bash
mineplex-chaind query staking validator <account_cosmosval>
```
...
```bash
mineplex-chaind query staking unbonding-delegations-from <account_cosmosval>
```
...
```bash
  mineplex-chaind query staking redelegations-from <account_cosmosval>
```
...
```bash
  mineplex-chaind query delegations-to <account_cosmosval>
```
