...
export default function useCosmosBankV1Beta1() {
  ...
  return {QueryBalance,QueryAllBalances,QuerySpendableBalances,QueryTotalSupply,QuerySupplyOf,QueryParams,QueryDenomMetadata,QueryDenomsMetadata,QueryDenomOwners,
  }
}